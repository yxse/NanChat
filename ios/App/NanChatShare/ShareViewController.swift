...
class ShareViewController:  UIViewController {
        ...
        Task {
            try await withThrowingTaskGroup(
                ...
                body: { taskGroup in
                    ...
                    self.sendData()
    // Move the completion call here after all work is done
    self.extensionContext!.completeRequest(returningItems: [], completionHandler: nil)
        }
    }
    ...
    private func sendData() {
        ...
        var urlComps = URLComponents(string: "nanchat://;")!
    ...
    fileprivate func createSharedFileUrl(_ url: URL?) -> String {
        ...
        let copyFileUrl =
        fileManager.containerURL(forSecurityApplicationGroupIdentifier: "group.com.nanchat.app")!
